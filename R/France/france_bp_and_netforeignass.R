...
# Chaves das séries
series_keys <- list(
  total     = "BPS.M.N.FR.W1.S1.S1.T.N.FA._T.F._Z.EUR._T._X.N.ALL",
  direct    = "BPS.M.N.FR.W1.S1.S1.T.N.FA.D.F._Z.EUR._T._X.N.ALL",
  portfolio = "BPS.M.N.FR.W1.S1.S1.T.N.FA.P.F._Z.EUR._T.M.N.ALL",
  other     = "BPS.M.N.FR.W1.S1.S1.T.N.FA.O.F._Z.EUR._T._X.N.ALL",
  reserve   = "BPS.M.N.FR.W1.S121.S1.T.A.FA.R.F._Z.EUR.X1._X.N.ALL",
  derivative= "BPS.M.N.FR.W1.S1.S1.T.N.FA.F.F7.T.EUR._T.T.N.ALL"
)

# PIB nominal mensal interpolado (exemplo fictício, substitua por série real se tiver)
gdp_monthly <- get_macro_data_ecb("MNA.Q.Y.FR.W2.S1.S1.B.B1GQ._Z._Z._Z.EUR.LR.N", parse_date = "none") %>%
  select(date, value) %>%
  rename(gdp = value)%>%
...
ggplot(df_stacked, aes(x = date, y = value, fill = variable)) +
  ...
  labs(
    title = "Net Financial Account - France",
...
bop_keys <- list(
  total     = "BPS.M.Y.FR.W1.S1.S1.T.B.CA._Z._Z._Z.EUR._T._X.N.ALL",
  goods     = "BPS.M.N.FR.W1.S1.S1.T.B.G._Z._Z._Z.EUR._T._X.N.ALL",
  services  = "BPS.M.N.FR.W1.S1.S1.T.B.S._Z._Z._Z.EUR._T._X.N.ALL",
  primary   = "BPS.M.N.FR.W1.S1.S1.T.B.IN1._Z._Z._Z.EUR._T._X.N.ALL",
  secondary = "BPS.M.N.FR.W1.S1.S1.T.B.IN2._Z._Z._Z.EUR._T._X.N.ALL"
)
...
gdp_quarterly <- get_macro_data_ecb("MNA.Q.Y.FR.W2.S1.S1.B.B1GQ._Z._Z._Z.EUR.LR.N", parse_date = "none") %>%
  select(date, value) %>%
  rename(gdp = value) %>%
  mutate(date = as.Date(as.yearqtr(date, format = "%Y-Q%q")))
...
position_keys <- list(
  direct     = "BPS.Q.N.FR.W1.S1.S1.LE.N.FA.D.F._Z.EUR._T._X.N.ALL",
  portfolio_debt  = "BPS.Q.N.FR.W1.S1.S1.LE.N.FA.P.F3.T.EUR._T.M.N.ALL",
  portfolio_equity = "BPS.Q.N.FR.W1.S1.S1.LE.N.FA.P.F5._Z.EUR._T.M.N.ALL",
  other      = "BPS.Q.N.FR.W1.S1.S1.LE.N.FA.O.F._Z.EUR._T._X.N.ALL",
  reserve    = "BPS.Q.N.FR.W1.S121.S1.LE.A.FA.R.F._Z.EUR.X1._X.N.ALL",
  derivative = "BPS.Q.N.FR.W1.S1.S1.LE.N.FA.F.F7.T.EUR._T.T.N.ALL"
)
...
ggplot(df_position_stacked, aes(x = date, y = value, fill = variable)) +
  ...
  labs(
    title = "Net International Investment Position - France",
    subtitle = paste(
